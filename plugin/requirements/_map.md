...
graph LR
  ...
  f_plugin_scripts_test_reqmap_py_153_4884["plugin/scripts/test_reqmap.py:153-4884"]
  CORE_DRIFT_003 -->|tested-by| f_plugin_scripts_test_reqmap_py_153_4884
  CORE_PARSE_001["Requirement reading<br><small>CORE-PARSE-001</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_50_4837["plugin/scripts/test_reqmap.py:50-4837"]
  CORE_PARSE_001 -->|tested-by| f_plugin_scripts_test_reqmap_py_50_4837
  CORE_SCAN_002["Member discovery<br><small>CORE-SCAN-002</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_3436_4868["plugin/scripts/test_reqmap.py:3436-4868"]
  REQ_ACVERIFY_019 -->|tested-by| f_plugin_scripts_test_reqmap_py_3436_4868
  REQ_CANDIDATES_009["Capability candidates (extraction plan)<br><small>REQ-CANDIDATES-009</small>"]
  ...
  REQ_CHECK_006["The gate<br><small>REQ-CHECK-006</small>"]
  f_plugin_scripts_reqmap_py_1347_1893["plugin/scripts/reqmap.py:1347-1893"]
  REQ_CHECK_006 -->|implements| f_plugin_scripts_reqmap_py_1347_1893
  f_plugin_scripts_test_reqmap_py_143_5046["plugin/scripts/test_reqmap.py:143-5046"]
  REQ_CHECK_006 -->|tested-by| f_plugin_scripts_test_reqmap_py_143_5046
  REQ_CMDREGISTRY_033["CLI command registry + generated integration artifacts<br><small>REQ-CMDREGISTRY-033</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_4766["plugin/scripts/test_reqmap.py:4766"]
  REQ_CMDREGISTRY_033 -->|tested-by| f_plugin_scripts_test_reqmap_py_4766
  REQ_COVERAGE_029["Untagged-code coverage signal<br><small>REQ-COVERAGE-029</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_2410_4998["plugin/scripts/test_reqmap.py:2410-4998"]
  REQ_INIT_012 -->|tested-by| f_plugin_scripts_test_reqmap_py_2410_4998
  REQ_LINT_014["Requirement readability linter<br><small>REQ-LINT-014</small>"]
  ...
  REQ_MAP_007["Requirement map (Mermaid MD + JSON)<br><small>REQ-MAP-007</small>"]
  f_plugin_scripts_reqmap_py_2752_4926["plugin/scripts/reqmap.py:2752-4926"]
  REQ_MAP_007 -->|implements| f_plugin_scripts_reqmap_py_2752_4926
  f_plugin_scripts_test_reqmap_py_880_4998["plugin/scripts/test_reqmap.py:880-4998"]
  REQ_MAP_007 -->|tested-by| f_plugin_scripts_test_reqmap_py_880_4998
  REQ_MEMBERDRIFT_027["Reverse-direction member drift<br><small>REQ-MEMBERDRIFT-027</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_2284_4948["plugin/scripts/test_reqmap.py:2284-4948"]
  REQ_NEXT_013 -->|tested-by| f_plugin_scripts_test_reqmap_py_2284_4948
  REQ_ORPHANCODE_034["Orphan-code warning<br><small>REQ-ORPHANCODE-034</small>"]
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_plugin_scripts_reqmap_py_2903_4942["plugin/scripts/reqmap.py:2903-4942"]
  REQ_PAGES_021 -->|implements| f_plugin_scripts_reqmap_py_2903_4942
  ...
  f_plugin_scripts_test_reqmap_py_2224_4948["plugin/scripts/test_reqmap.py:2224-4948"]
  REQ_PROMOTE_011 -->|tested-by| f_plugin_scripts_test_reqmap_py_2224_4948
  REQ_PROMOTE_TODO_001["Promote a TODO item into a requirement draft<br><small>REQ-PROMOTE-TODO-001</small>"]
  ...
  f_plugin_scripts_test_reqmap_py_3629_4948["plugin/scripts/test_reqmap.py:3629-4948"]
  REQ_PROMOTE_TODO_001 -->|tested-by| f_plugin_scripts_test_reqmap_py_3629_4948
  REQ_PROSE_024["Prose capability classification & drafting<br><small>REQ-PROSE-024</small>"]
  ...
  REQ_PYFLOOR_040 -->|tested-by| f_plugin_scripts_test_reqmap_py_4585
  REQ_REGISTRYLAG_035["Registry-lag signal — commits since the requirements dir was last touched<br><small>REQ-REGISTRYLAG-035</small>"]
  ...
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_plugin_scripts_reqmap_py_5093["plugin/scripts/reqmap.py:5093"]
  REQ_REVIEW_022 -->|implements| f_plugin_scripts_reqmap_py_5093
  ...
  f_plugin_scripts_test_reqmap_py_5072["plugin/scripts/test_reqmap.py:5072"]
  REQ_ROADMAP_038 -->|tested-by| f_plugin_scripts_test_reqmap_py_5072
  REQ_SCAN_005["List members per capability<br><small>REQ-SCAN-005</small>"]
  ...
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_plugin_scripts_reqmap_py_3907_5317["plugin/scripts/reqmap.py:3907-5317"]
  REQ_SITE_026 -->|implements| f_plugin_scripts_reqmap_py_3907_5317
  ...
  REQ_VIEWER_007["Self-contained HTML map viewer<br><small>REQ-VIEWER-007</small>"]
  f_plugin_scripts_reqmap_py_1101_5077["plugin/scripts/reqmap.py:1101-5077"]
  REQ_VIEWER_007 -->|implements| f_plugin_scripts_reqmap_py_1101_5077
  f_plugin_scripts_test_reqmap_py_1415_5115["plugin/scripts/test_reqmap.py:1415-5115"]
  REQ_VIEWER_007 -->|tested-by| f_plugin_scripts_test_reqmap_py_1415_5115
  REQ_VLEVEL_037["Verification levels<br><small>REQ-VLEVEL-037</small>"]
