...
graph LR
  ...
  REQ_COVERAGE_029["Untagged-code coverage signal<br><small>REQ-COVERAGE-029</small>"]
  f_scripts_reqmap_py_3421["scripts/reqmap.py:3421"]
  REQ_COVERAGE_029 -->|implements| f_scripts_reqmap_py_3421
  ...
  REQ_HEALTH_017["Corpus health snapshot<br><small>REQ-HEALTH-017</small>"]
  f_scripts_reqmap_py_3359["scripts/reqmap.py:3359"]
  REQ_HEALTH_017 -->|implements| f_scripts_reqmap_py_3359
  ...
  REQ_INIT_012["First-use bootstrap<br><small>REQ-INIT-012</small>"]
  f_scripts_reqmap_py_3538_3567["scripts/reqmap.py:3538-3567"]
  REQ_INIT_012 -->|implements| f_scripts_reqmap_py_3538_3567
  ...
  REQ_LINT_014["Requirement readability linter<br><small>REQ-LINT-014</small>"]
  f_scripts_reqmap_py_2788_2979["scripts/reqmap.py:2788-2979"]
  REQ_LINT_014 -->|implements| f_scripts_reqmap_py_2788_2979
  ...
  REQ_MAP_007["Requirement map (Mermaid MD + JSON)<br><small>REQ-MAP-007</small>"]
  f_scripts_reqmap_py_2512_4598["scripts/reqmap.py:2512-4598"]
  REQ_MAP_007 -->|implements| f_scripts_reqmap_py_2512_4598
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_scripts_reqmap_py_2623_4614["scripts/reqmap.py:2623-4614"]
  REQ_PAGES_021 -->|implements| f_scripts_reqmap_py_2623_4614
  ...
  REQ_REGISTRYLAG_035["Registry-lag signal — commits since the requirements dir was last touched<br><small>REQ-REGISTRYLAG-035</small>"]
  f_scripts_reqmap_py_3333_3427["scripts/reqmap.py:3333-3427"]
  REQ_REGISTRYLAG_035 -->|implements| f_scripts_reqmap_py_3333_3427
  f_scripts_test_reqmap_py_2819["scripts/test_reqmap.py:2819"]
  REQ_REGISTRYLAG_035 -->|tested-by| f_scripts_test_reqmap_py_2819
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_scripts_reqmap_py_4765["scripts/reqmap.py:4765"]
  REQ_REVIEW_022 -->|implements| f_scripts_reqmap_py_4765
  ...
  REQ_SEARCH_036["Free-text requirement search<br><small>REQ-SEARCH-036</small>"]
  f_scripts_reqmap_py_3212["scripts/reqmap.py:3212"]
  REQ_SEARCH_036 -->|implements| f_scripts_reqmap_py_3212
  f_scripts_test_reqmap_py_2671["scripts/test_reqmap.py:2671"]
  REQ_SEARCH_036 -->|tested-by| f_scripts_test_reqmap_py_2671
  REQ_SHOW_015["Single-requirement dossier<br><small>REQ-SHOW-015</small>"]
  f_scripts_reqmap_py_3021["scripts/reqmap.py:3021"]
  REQ_SHOW_015 -->|implements| f_scripts_reqmap_py_3021
  f_scripts_test_reqmap_py_2545["scripts/test_reqmap.py:2545"]
  REQ_SHOW_015 -->|tested-by| f_scripts_test_reqmap_py_2545
  REQ_SIMILAR_016["Duplicate-capability detector<br><small>REQ-SIMILAR-016</small>"]
  f_scripts_reqmap_py_3103_3164["scripts/reqmap.py:3103-3164"]
  REQ_SIMILAR_016 -->|implements| f_scripts_reqmap_py_3103_3164
  f_scripts_test_reqmap_py_2609["scripts/test_reqmap.py:2609"]
  REQ_SIMILAR_016 -->|tested-by| f_scripts_test_reqmap_py_2609
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_scripts_reqmap_py_3593_4982["scripts/reqmap.py:3593-4982"]
  REQ_SITE_026 -->|implements| f_scripts_reqmap_py_3593_4982
  ...
  REQ_TRACE_020["Upstream traceability<br><small>REQ-TRACE-020</small>"]
  f_scripts_reqmap_py_1514_3056["scripts/reqmap.py:1514-3056"]
  REQ_TRACE_020 -->|implements| f_scripts_reqmap_py_1514_3056
  f_scripts_test_reqmap_py_3133["scripts/test_reqmap.py:3133"]
  REQ_TRACE_020 -->|tested-by| f_scripts_test_reqmap_py_3133
  REQ_VIEWER_007["Self-contained HTML map viewer<br><small>REQ-VIEWER-007</small>"]
  f_scripts_reqmap_py_4727_4749["scripts/reqmap.py:4727-4749"]
  REQ_VIEWER_007 -->|implements| f_scripts_reqmap_py_4727_4749
