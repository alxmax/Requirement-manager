...
graph LR
  ...
  REQ_ACVERIFY_019["Per-criterion test coverage<br><small>REQ-ACVERIFY-019</small>"]
  f_plugin_scripts_reqmap_py_1110_3307["plugin/scripts/reqmap.py:1110-3307"]
  REQ_ACVERIFY_019 -->|implements| f_plugin_scripts_reqmap_py_1110_3307
  ...
  REQ_CANDIDATES_009["Capability candidates (extraction plan)<br><small>REQ-CANDIDATES-009</small>"]
  f_plugin_scripts_reqmap_py_2885_3051["plugin/scripts/reqmap.py:2885-3051"]
  REQ_CANDIDATES_009 -->|implements| f_plugin_scripts_reqmap_py_2885_3051
  ...
  f_plugin_scripts_reqmap_py_1681_5958["plugin/scripts/reqmap.py:1681-5958"]
  REQ_CHECK_006 -->|implements| f_plugin_scripts_reqmap_py_1681_5958
  ...
  REQ_COVERAGE_029["Untagged-code coverage signal<br><small>REQ-COVERAGE-029</small>"]
  f_plugin_scripts_reqmap_py_4767["plugin/scripts/reqmap.py:4767"]
  REQ_COVERAGE_029 -->|implements| f_plugin_scripts_reqmap_py_4767
  ...
  REQ_EXTRACT_008["Legacy extraction<br><small>REQ-EXTRACT-008</small>"]
  f_plugin_scripts_reqmap_py_2686_2863["plugin/scripts/reqmap.py:2686-2863"]
  REQ_EXTRACT_008 -->|implements| f_plugin_scripts_reqmap_py_2686_2863
  ...
  REQ_FINDINGS_010["Open-findings report<br><small>REQ-FINDINGS-010</small>"]
  f_plugin_scripts_reqmap_py_3173_5026["plugin/scripts/reqmap.py:3173-5026"]
  REQ_FINDINGS_010 -->|implements| f_plugin_scripts_reqmap_py_3173_5026
  ...
  REQ_HEALTH_017["Corpus health snapshot<br><small>REQ-HEALTH-017</small>"]
  f_plugin_scripts_reqmap_py_4700["plugin/scripts/reqmap.py:4700"]
  REQ_HEALTH_017 -->|implements| f_plugin_scripts_reqmap_py_4700
  ...
  REQ_INIT_012["First-use bootstrap<br><small>REQ-INIT-012</small>"]
  f_plugin_scripts_reqmap_py_4896_4932["plugin/scripts/reqmap.py:4896-4932"]
  REQ_INIT_012 -->|implements| f_plugin_scripts_reqmap_py_4896_4932
  ...
  REQ_LINT_014["Requirement readability linter<br><small>REQ-LINT-014</small>"]
  f_plugin_scripts_reqmap_py_4003_4222["plugin/scripts/reqmap.py:4003-4222"]
  REQ_LINT_014 -->|implements| f_plugin_scripts_reqmap_py_4003_4222
  ...
  REQ_LINTCHECKS_025["Readability & scope checks<br><small>REQ-LINTCHECKS-025</small>"]
  f_plugin_scripts_reqmap_py_4032_4236["plugin/scripts/reqmap.py:4032-4236"]
  REQ_LINTCHECKS_025 -->|implements| f_plugin_scripts_reqmap_py_4032_4236
  ...
  f_plugin_scripts_reqmap_py_1636_6047["plugin/scripts/reqmap.py:1636-6047"]
  REQ_MAP_007 -->|implements| f_plugin_scripts_reqmap_py_1636_6047
  ...
  REQ_NEW_004["Scaffold a requirement<br><small>REQ-NEW-004</small>"]
  f_plugin_scripts_reqmap_py_2470_2492["plugin/scripts/reqmap.py:2470-2492"]
  REQ_NEW_004 -->|implements| f_plugin_scripts_reqmap_py_2470_2492
  ...
  REQ_NEXT_013["What-should-I-do-next report<br><small>REQ-NEXT-013</small>"]
  f_plugin_scripts_reqmap_py_1420_3862["plugin/scripts/reqmap.py:1420-3862"]
  REQ_NEXT_013 -->|implements| f_plugin_scripts_reqmap_py_1420_3862
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_plugin_scripts_reqmap_py_3784_6063["plugin/scripts/reqmap.py:3784-6063"]
  REQ_PAGES_021 -->|implements| f_plugin_scripts_reqmap_py_3784_6063
  ...
  REQ_PIPE_046["A closed output pipe ends a command quietly<br><small>REQ-PIPE-046</small>"]
  f_plugin_scripts_reqmap_py_6665_6676["plugin/scripts/reqmap.py:6665-6676"]
  REQ_PIPE_046 -->|implements| f_plugin_scripts_reqmap_py_6665_6676
  ...
  REQ_PROMOTE_011["confirm<br><small>REQ-PROMOTE-011</small>"]
  f_plugin_scripts_reqmap_py_2603_2629["plugin/scripts/reqmap.py:2603-2629"]
  REQ_PROMOTE_011 -->|implements| f_plugin_scripts_reqmap_py_2603_2629
  ...
  REQ_PROMOTE_TODO_001["Promote a TODO item into a requirement draft<br><small>REQ-PROMOTE-TODO-001</small>"]
  f_plugin_scripts_reqmap_py_2514_2571["plugin/scripts/reqmap.py:2514-2571"]
  REQ_PROMOTE_TODO_001 -->|implements| f_plugin_scripts_reqmap_py_2514_2571
  ...
  REQ_PROSE_024["Prose capability classification & drafting<br><small>REQ-PROSE-024</small>"]
  f_plugin_scripts_reqmap_py_2694_2753["plugin/scripts/reqmap.py:2694-2753"]
  REQ_PROSE_024 -->|implements| f_plugin_scripts_reqmap_py_2694_2753
  ...
  REQ_REGISTRYLAG_035["Registry-lag signal — commits since the requirements dir was last touched<br><small>REQ-REGISTRYLAG-035</small>"]
  f_plugin_scripts_reqmap_py_4674_4773["plugin/scripts/reqmap.py:4674-4773"]
  REQ_REGISTRYLAG_035 -->|implements| f_plugin_scripts_reqmap_py_4674_4773
  ...
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_plugin_scripts_reqmap_py_6387["plugin/scripts/reqmap.py:6387"]
  REQ_REVIEW_022 -->|implements| f_plugin_scripts_reqmap_py_6387
  ...
  REQ_ROADMAP_038["Roadmap coherence signals<br><small>REQ-ROADMAP-038</small>"]
  f_plugin_scripts_reqmap_py_3387_4779["plugin/scripts/reqmap.py:3387-4779"]
  REQ_ROADMAP_038 -->|implements| f_plugin_scripts_reqmap_py_3387_4779
  ...
  f_plugin_scripts_reqmap_py_4510["plugin/scripts/reqmap.py:4510"]
  REQ_SEARCH_036 -->|implements| f_plugin_scripts_reqmap_py_4510
  ...
  REQ_SHOW_015["Single-requirement dossier<br><small>REQ-SHOW-015</small>"]
  f_plugin_scripts_reqmap_py_4269["plugin/scripts/reqmap.py:4269"]
  REQ_SHOW_015 -->|implements| f_plugin_scripts_reqmap_py_4269
  ...
  REQ_SIMILAR_016["Duplicate-capability detector<br><small>REQ-SIMILAR-016</small>"]
  f_plugin_scripts_reqmap_py_4358_4447["plugin/scripts/reqmap.py:4358-4447"]
  REQ_SIMILAR_016 -->|implements| f_plugin_scripts_reqmap_py_4358_4447
  ...
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_plugin_scripts_reqmap_py_4958_6637["plugin/scripts/reqmap.py:4958-6637"]
  REQ_SITE_026 -->|implements| f_plugin_scripts_reqmap_py_4958_6637
  ...
  REQ_SUGGESTVERIFIES_047["Suggest per-criterion 'verifies:' tags<br><small>REQ-SUGGESTVERIFIES-047</small>"]
  f_plugin_scripts_reqmap_py_6232_6360["plugin/scripts/reqmap.py:6232-6360"]
  REQ_SUGGESTVERIFIES_047 -->|implements| f_plugin_scripts_reqmap_py_6232_6360
  ...
  REQ_TRACE_020["Upstream traceability<br><small>REQ-TRACE-020</small>"]
  f_plugin_scripts_reqmap_py_1973_4304["plugin/scripts/reqmap.py:1973-4304"]
  REQ_TRACE_020 -->|implements| f_plugin_scripts_reqmap_py_1973_4304
  ...
  f_plugin_scripts_reqmap_py_3468_3760["plugin/scripts/reqmap.py:3468-3760"]
  REQ_TRANSLATE_044 -->|implements| f_plugin_scripts_reqmap_py_3468_3760
  ...
  f_plugin_scripts_reqmap_py_1267_6206["plugin/scripts/reqmap.py:1267-6206"]
  REQ_VIEWER_007 -->|implements| f_plugin_scripts_reqmap_py_1267_6206
  ...
  REQ_VLEVEL_037["Verification levels<br><small>REQ-VLEVEL-037</small>"]
  f_plugin_scripts_reqmap_py_1523_4269["plugin/scripts/reqmap.py:1523-4269"]
  REQ_VLEVEL_037 -->|implements| f_plugin_scripts_reqmap_py_1523_4269
