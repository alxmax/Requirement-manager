...
graph LR
  CORE_DRIFT_003["Contract hashing & lock<br><small>CORE-DRIFT-003</small>"]
  f_scripts_reqmap_py_474_508["scripts/reqmap.py:474-508"]
  CORE_DRIFT_003 -->|implements| f_scripts_reqmap_py_474_508
  ...
  REQ_ACVERIFY_019["Per-criterion test coverage<br><small>REQ-ACVERIFY-019</small>"]
  f_scripts_reqmap_py_403_684["scripts/reqmap.py:403-684"]
  REQ_ACVERIFY_019 -->|implements| f_scripts_reqmap_py_403_684
  f_scripts_test_reqmap_py_2238["scripts/test_reqmap.py:2238"]
  REQ_ACVERIFY_019 -->|tested-by| f_scripts_test_reqmap_py_2238
  REQ_CANDIDATES_009["Capability candidates (extraction plan)<br><small>REQ-CANDIDATES-009</small>"]
  f_scripts_reqmap_py_1169_1316["scripts/reqmap.py:1169-1316"]
  REQ_CANDIDATES_009 -->|implements| f_scripts_reqmap_py_1169_1316
  ...
  REQ_CHECK_006["The gate<br><small>REQ-CHECK-006</small>"]
  f_scripts_reqmap_py_461_761["scripts/reqmap.py:461-761"]
  REQ_CHECK_006 -->|implements| f_scripts_reqmap_py_461_761
  ...
  REQ_EXTRACT_008["Legacy extraction<br><small>REQ-EXTRACT-008</small>"]
  f_scripts_reqmap_py_1006_1152["scripts/reqmap.py:1006-1152"]
  REQ_EXTRACT_008 -->|implements| f_scripts_reqmap_py_1006_1152
  ...
  REQ_FINDINGS_010["Open-findings report<br><small>REQ-FINDINGS-010</small>"]
  f_scripts_reqmap_py_1422_1509["scripts/reqmap.py:1422-1509"]
  REQ_FINDINGS_010 -->|implements| f_scripts_reqmap_py_1422_1509
  ...
  REQ_HEALTH_017["Corpus health snapshot<br><small>REQ-HEALTH-017</small>"]
  f_scripts_reqmap_py_2179["scripts/reqmap.py:2179"]
  REQ_HEALTH_017 -->|implements| f_scripts_reqmap_py_2179
  f_scripts_test_reqmap_py_2098["scripts/test_reqmap.py:2098"]
  REQ_HEALTH_017 -->|tested-by| f_scripts_test_reqmap_py_2098
  REQ_INIT_012["First-use bootstrap<br><small>REQ-INIT-012</small>"]
  f_scripts_reqmap_py_2300_2329["scripts/reqmap.py:2300-2329"]
  REQ_INIT_012 -->|implements| f_scripts_reqmap_py_2300_2329
  f_scripts_test_reqmap_py_1626["scripts/test_reqmap.py:1626"]
  REQ_INIT_012 -->|tested-by| f_scripts_test_reqmap_py_1626
  REQ_LINT_014["Requirement readability linter<br><small>REQ-LINT-014</small>"]
  f_scripts_reqmap_py_1802_1968["scripts/reqmap.py:1802-1968"]
  REQ_LINT_014 -->|implements| f_scripts_reqmap_py_1802_1968
  f_scripts_test_reqmap_py_1812["scripts/test_reqmap.py:1812"]
  REQ_LINT_014 -->|tested-by| f_scripts_test_reqmap_py_1812
  REQ_LINTCHECKS_025["Readability & scope checks<br><small>REQ-LINTCHECKS-025</small>"]
  f_scripts_reqmap_py_1831_1860["scripts/reqmap.py:1831-1860"]
  REQ_LINTCHECKS_025 -->|implements| f_scripts_reqmap_py_1831_1860
  f_scripts_test_reqmap_py_1812["scripts/test_reqmap.py:1812"]
  REQ_LINTCHECKS_025 -->|tested-by| f_scripts_test_reqmap_py_1812
  REQ_MAP_007["Requirement map (Mermaid MD + JSON)<br><small>REQ-MAP-007</small>"]
  f_scripts_reqmap_py_1544_3294["scripts/reqmap.py:1544-3294"]
  REQ_MAP_007 -->|implements| f_scripts_reqmap_py_1544_3294
  f_scripts_test_reqmap_py_399_1336["scripts/test_reqmap.py:399-1336"]
  REQ_MAP_007 -->|tested-by| f_scripts_test_reqmap_py_399_1336
  REQ_NEW_004["Scaffold a requirement<br><small>REQ-NEW-004</small>"]
  f_scripts_reqmap_py_860["scripts/reqmap.py:860"]
  REQ_NEW_004 -->|implements| f_scripts_reqmap_py_860
  f_scripts_test_reqmap_py_591["scripts/test_reqmap.py:591"]
  REQ_NEW_004 -->|tested-by| f_scripts_test_reqmap_py_591
  REQ_NEXT_013["What-should-I-do-next report<br><small>REQ-NEXT-013</small>"]
  f_scripts_reqmap_py_1677_1690["scripts/reqmap.py:1677-1690"]
  REQ_NEXT_013 -->|implements| f_scripts_reqmap_py_1677_1690
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_scripts_reqmap_py_1650_3310["scripts/reqmap.py:1650-3310"]
  REQ_PAGES_021 -->|implements| f_scripts_reqmap_py_1650_3310
  ...
  REQ_PROMOTE_011["confirm<br><small>REQ-PROMOTE-011</small>"]
  f_scripts_reqmap_py_957_972["scripts/reqmap.py:957-972"]
  REQ_PROMOTE_011 -->|implements| f_scripts_reqmap_py_957_972
  f_scripts_test_reqmap_py_1440["scripts/test_reqmap.py:1440"]
  REQ_PROMOTE_011 -->|tested-by| f_scripts_test_reqmap_py_1440
  REQ_PROMOTE_TODO_001["Promote a TODO item into a requirement draft<br><small>REQ-PROMOTE-TODO-001</small>"]
  f_scripts_reqmap_py_881_927["scripts/reqmap.py:881-927"]
  REQ_PROMOTE_TODO_001 -->|implements| f_scripts_reqmap_py_881_927
  f_scripts_test_reqmap_py_2431["scripts/test_reqmap.py:2431"]
  REQ_PROMOTE_TODO_001 -->|tested-by| f_scripts_test_reqmap_py_2431
  REQ_PROSE_024["Prose capability classification & drafting<br><small>REQ-PROSE-024</small>"]
  f_scripts_reqmap_py_1014_1067["scripts/reqmap.py:1014-1067"]
  REQ_PROSE_024 -->|implements| f_scripts_reqmap_py_1014_1067
  f_scripts_test_reqmap_py_356_542["scripts/test_reqmap.py:356-542"]
  REQ_PROSE_024 -->|tested-by| f_scripts_test_reqmap_py_356_542
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_scripts_reqmap_py_3450["scripts/reqmap.py:3450"]
  REQ_REVIEW_022 -->|implements| f_scripts_reqmap_py_3450
  ...
  REQ_SCAN_005["List members per capability<br><small>REQ-SCAN-005</small>"]
  f_scripts_reqmap_py_530["scripts/reqmap.py:530"]
  REQ_SCAN_005 -->|implements| f_scripts_reqmap_py_530
  ...
  REQ_SHOW_015["Single-requirement dossier<br><small>REQ-SHOW-015</small>"]
  f_scripts_reqmap_py_1999["scripts/reqmap.py:1999"]
  REQ_SHOW_015 -->|implements| f_scripts_reqmap_py_1999
  f_scripts_test_reqmap_py_1972["scripts/test_reqmap.py:1972"]
  REQ_SHOW_015 -->|tested-by| f_scripts_test_reqmap_py_1972
  REQ_SIMILAR_016["Duplicate-capability detector<br><small>REQ-SIMILAR-016</small>"]
  f_scripts_reqmap_py_2081_2142["scripts/reqmap.py:2081-2142"]
  REQ_SIMILAR_016 -->|implements| f_scripts_reqmap_py_2081_2142
  f_scripts_test_reqmap_py_2036["scripts/test_reqmap.py:2036"]
  REQ_SIMILAR_016 -->|tested-by| f_scripts_test_reqmap_py_2036
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_scripts_reqmap_py_2355_3650["scripts/reqmap.py:2355-3650"]
  REQ_SITE_026 -->|implements| f_scripts_reqmap_py_2355_3650
  f_scripts_test_reqmap_py_3001["scripts/test_reqmap.py:3001"]
  REQ_SITE_026 -->|tested-by| f_scripts_test_reqmap_py_3001
  REQ_TESTLINK_018["Test-link integrity check<br><small>REQ-TESTLINK-018</small>"]
  f_scripts_reqmap_py_580_676["scripts/reqmap.py:580-676"]
  REQ_TESTLINK_018 -->|implements| f_scripts_reqmap_py_580_676
  f_scripts_test_reqmap_py_2174["scripts/test_reqmap.py:2174"]
  REQ_TESTLINK_018 -->|tested-by| f_scripts_test_reqmap_py_2174
  REQ_TRACE_020["Upstream traceability<br><small>REQ-TRACE-020</small>"]
  f_scripts_reqmap_py_652_2034["scripts/reqmap.py:652-2034"]
  REQ_TRACE_020 -->|implements| f_scripts_reqmap_py_652_2034
  f_scripts_test_reqmap_py_2308["scripts/test_reqmap.py:2308"]
  REQ_TRACE_020 -->|tested-by| f_scripts_test_reqmap_py_2308
  REQ_VIEWER_007["Self-contained HTML map viewer<br><small>REQ-VIEWER-007</small>"]
  f_scripts_reqmap_py_3421_3434["scripts/reqmap.py:3421-3434"]
  REQ_VIEWER_007 -->|implements| f_scripts_reqmap_py_3421_3434
