...
graph LR
  ...
  f_scripts_test_reqmap_py_153_4511["scripts/test_reqmap.py:153-4511"]
  CORE_DRIFT_003 -->|tested-by| f_scripts_test_reqmap_py_153_4511
  CORE_PARSE_001["Requirement reading<br><small>CORE-PARSE-001</small>"]
  f_scripts_reqmap_py_658_729["scripts/reqmap.py:658-729"]
  CORE_PARSE_001 -->|implements| f_scripts_reqmap_py_658_729
  f_scripts_test_reqmap_py_50_4464["scripts/test_reqmap.py:50-4464"]
  CORE_PARSE_001 -->|tested-by| f_scripts_test_reqmap_py_50_4464
  CORE_SCAN_002["Member discovery<br><small>CORE-SCAN-002</small>"]
  ...
  f_scripts_test_reqmap_py_3113_4495["scripts/test_reqmap.py:3113-4495"]
  REQ_ACVERIFY_019 -->|tested-by| f_scripts_test_reqmap_py_3113_4495
  REQ_CANDIDATES_009["Capability candidates (extraction plan)<br><small>REQ-CANDIDATES-009</small>"]
  ...
  f_scripts_test_reqmap_py_143_4673["scripts/test_reqmap.py:143-4673"]
  REQ_CHECK_006 -->|tested-by| f_scripts_test_reqmap_py_143_4673
  REQ_CMDREGISTRY_033["CLI command registry + generated integration artifacts<br><small>REQ-CMDREGISTRY-033</small>"]
  f_scripts_reqmap_py_132_1691["scripts/reqmap.py:132-1691"]
  REQ_CMDREGISTRY_033 -->|implements| f_scripts_reqmap_py_132_1691
  f_scripts_test_reqmap_py_4393["scripts/test_reqmap.py:4393"]
  REQ_CMDREGISTRY_033 -->|tested-by| f_scripts_test_reqmap_py_4393
  REQ_COVERAGE_029["Untagged-code coverage signal<br><small>REQ-COVERAGE-029</small>"]
  f_scripts_reqmap_py_3437["scripts/reqmap.py:3437"]
  REQ_COVERAGE_029 -->|implements| f_scripts_reqmap_py_3437
  f_scripts_test_reqmap_py_2844["scripts/test_reqmap.py:2844"]
  REQ_COVERAGE_029 -->|tested-by| f_scripts_test_reqmap_py_2844
  REQ_DOCBUNDLE_026["Untagged doc-bundle warning<br><small>REQ-DOCBUNDLE-026</small>"]
  ...
  f_scripts_test_reqmap_py_2801_2963["scripts/test_reqmap.py:2801-2963"]
  REQ_HEALTH_017 -->|tested-by| f_scripts_test_reqmap_py_2801_2963
  REQ_INIT_012["First-use bootstrap<br><small>REQ-INIT-012</small>"]
  f_scripts_reqmap_py_3554_3583["scripts/reqmap.py:3554-3583"]
  REQ_INIT_012 -->|implements| f_scripts_reqmap_py_3554_3583
  f_scripts_test_reqmap_py_2121_4625["scripts/test_reqmap.py:2121-4625"]
  REQ_INIT_012 -->|tested-by| f_scripts_test_reqmap_py_2121_4625
  REQ_LINT_014["Requirement readability linter<br><small>REQ-LINT-014</small>"]
  ...
  REQ_MAP_007["Requirement map (Mermaid MD + JSON)<br><small>REQ-MAP-007</small>"]
  f_scripts_reqmap_py_2528_4621["scripts/reqmap.py:2528-4621"]
  REQ_MAP_007 -->|implements| f_scripts_reqmap_py_2528_4621
  f_scripts_test_reqmap_py_679_4625["scripts/test_reqmap.py:679-4625"]
  REQ_MAP_007 -->|tested-by| f_scripts_test_reqmap_py_679_4625
  REQ_MEMBERDRIFT_027["Reverse-direction member drift<br><small>REQ-MEMBERDRIFT-027</small>"]
  ...
  f_scripts_test_reqmap_py_1995_4575["scripts/test_reqmap.py:1995-4575"]
  REQ_NEXT_013 -->|tested-by| f_scripts_test_reqmap_py_1995_4575
  REQ_ORPHANCODE_034["Orphan-code warning<br><small>REQ-ORPHANCODE-034</small>"]
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_scripts_reqmap_py_2639_4637["scripts/reqmap.py:2639-4637"]
  REQ_PAGES_021 -->|implements| f_scripts_reqmap_py_2639_4637
  ...
  f_scripts_test_reqmap_py_1935_4575["scripts/test_reqmap.py:1935-4575"]
  REQ_PROMOTE_011 -->|tested-by| f_scripts_test_reqmap_py_1935_4575
  REQ_PROMOTE_TODO_001["Promote a TODO item into a requirement draft<br><small>REQ-PROMOTE-TODO-001</small>"]
  f_scripts_reqmap_py_1815_1871["scripts/reqmap.py:1815-1871"]
  REQ_PROMOTE_TODO_001 -->|implements| f_scripts_reqmap_py_1815_1871
  f_scripts_test_reqmap_py_3306_4575["scripts/test_reqmap.py:3306-4575"]
  REQ_PROMOTE_TODO_001 -->|tested-by| f_scripts_test_reqmap_py_3306_4575
  REQ_PROSE_024["Prose capability classification & drafting<br><small>REQ-PROSE-024</small>"]
  ...
  f_scripts_test_reqmap_py_2869["scripts/test_reqmap.py:2869"]
  REQ_REGISTRYLAG_035 -->|tested-by| f_scripts_test_reqmap_py_2869
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_scripts_reqmap_py_4788["scripts/reqmap.py:4788"]
  REQ_REVIEW_022 -->|implements| f_scripts_reqmap_py_4788
  f_scripts_test_reqmap_py_3373["scripts/test_reqmap.py:3373"]
  REQ_REVIEW_022 -->|tested-by| f_scripts_test_reqmap_py_3373
  ...
  f_scripts_test_reqmap_py_3434["scripts/test_reqmap.py:3434"]
  REQ_SCANCACHE_023 -->|tested-by| f_scripts_test_reqmap_py_3434
  REQ_SEARCH_036["Free-text requirement search<br><small>REQ-SEARCH-036</small>"]
  f_scripts_reqmap_py_3228["scripts/reqmap.py:3228"]
  REQ_SEARCH_036 -->|implements| f_scripts_reqmap_py_3228
  f_scripts_test_reqmap_py_2721["scripts/test_reqmap.py:2721"]
  REQ_SEARCH_036 -->|tested-by| f_scripts_test_reqmap_py_2721
  REQ_SHOW_015["Single-requirement dossier<br><small>REQ-SHOW-015</small>"]
  f_scripts_reqmap_py_3037["scripts/reqmap.py:3037"]
  REQ_SHOW_015 -->|implements| f_scripts_reqmap_py_3037
  f_scripts_test_reqmap_py_2595["scripts/test_reqmap.py:2595"]
  REQ_SHOW_015 -->|tested-by| f_scripts_test_reqmap_py_2595
  REQ_SIMILAR_016["Duplicate-capability detector<br><small>REQ-SIMILAR-016</small>"]
  f_scripts_reqmap_py_3119_3180["scripts/reqmap.py:3119-3180"]
  REQ_SIMILAR_016 -->|implements| f_scripts_reqmap_py_3119_3180
  f_scripts_test_reqmap_py_2659["scripts/test_reqmap.py:2659"]
  REQ_SIMILAR_016 -->|tested-by| f_scripts_test_reqmap_py_2659
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_scripts_reqmap_py_3609_5005["scripts/reqmap.py:3609-5005"]
  REQ_SITE_026 -->|implements| f_scripts_reqmap_py_3609_5005
  f_scripts_test_reqmap_py_4075["scripts/test_reqmap.py:4075"]
  REQ_SITE_026 -->|tested-by| f_scripts_test_reqmap_py_4075
  REQ_TESTLINK_018["Test-link integrity check<br><small>REQ-TESTLINK-018</small>"]
  f_scripts_reqmap_py_1434_1543["scripts/reqmap.py:1434-1543"]
  REQ_TESTLINK_018 -->|implements| f_scripts_reqmap_py_1434_1543
  f_scripts_test_reqmap_py_3037["scripts/test_reqmap.py:3037"]
  REQ_TESTLINK_018 -->|tested-by| f_scripts_test_reqmap_py_3037
  REQ_TRACE_020["Upstream traceability<br><small>REQ-TRACE-020</small>"]
  f_scripts_reqmap_py_1515_3072["scripts/reqmap.py:1515-3072"]
  REQ_TRACE_020 -->|implements| f_scripts_reqmap_py_1515_3072
  f_scripts_test_reqmap_py_3183["scripts/test_reqmap.py:3183"]
  REQ_TRACE_020 -->|tested-by| f_scripts_test_reqmap_py_3183
  REQ_VIEWER_007["Self-contained HTML map viewer<br><small>REQ-VIEWER-007</small>"]
  f_scripts_reqmap_py_4750_4772["scripts/reqmap.py:4750-4772"]
  REQ_VIEWER_007 -->|implements| f_scripts_reqmap_py_4750_4772
