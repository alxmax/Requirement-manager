...
graph LR
  ...
  REQ_ACVERIFY_019 -->|tested-by| f_scripts_test_reqmap_py_2401
  REQ_CANDIDATES_009["Capability candidates (extraction plan)<br><small>REQ-CANDIDATES-009</small>"]
  ...
  f_scripts_test_reqmap_py_141_3389["scripts/test_reqmap.py:141-3389"]
  REQ_CHECK_006 -->|tested-by| f_scripts_test_reqmap_py_141_3389
  REQ_DOCBUNDLE_026["Untagged doc-bundle warning<br><small>REQ-DOCBUNDLE-026</small>"]
  ...
  REQ_INIT_012["First-use bootstrap<br><small>REQ-INIT-012</small>"]
  f_scripts_reqmap_py_2572_2601["scripts/reqmap.py:2572-2601"]
  ...
  REQ_MAP_007["Requirement map (Mermaid MD + JSON)<br><small>REQ-MAP-007</small>"]
  f_scripts_reqmap_py_1723_3566["scripts/reqmap.py:1723-3566"]
  REQ_MAP_007 -->|implements| f_scripts_reqmap_py_1723_3566
  ...
  REQ_PAGES_021["Publish & gate the GitHub Pages map copy<br><small>REQ-PAGES-021</small>"]
  f_scripts_reqmap_py_1829_3582["scripts/reqmap.py:1829-3582"]
  REQ_PAGES_021 -->|implements| f_scripts_reqmap_py_1829_3582
  ...
  f_scripts_test_reqmap_py_2594["scripts/test_reqmap.py:2594"]
  REQ_PROMOTE_TODO_001 -->|tested-by| f_scripts_test_reqmap_py_2594
  REQ_PROSE_024["Prose capability classification & drafting<br><small>REQ-PROSE-024</small>"]
  ...
  REQ_REVIEW_022["AI requirement-quality review (deterministic plan + advisory pass)<br><small>REQ-REVIEW-022</small>"]
  f_scripts_reqmap_py_3731["scripts/reqmap.py:3731"]
  REQ_REVIEW_022 -->|implements| f_scripts_reqmap_py_3731
  f_scripts_test_reqmap_py_2636["scripts/test_reqmap.py:2636"]
  REQ_REVIEW_022 -->|tested-by| f_scripts_test_reqmap_py_2636
  ...
  f_scripts_test_reqmap_py_2688["scripts/test_reqmap.py:2688"]
  REQ_SCANCACHE_023 -->|tested-by| f_scripts_test_reqmap_py_2688
  REQ_SHOW_015["Single-requirement dossier<br><small>REQ-SHOW-015</small>"]
  ...
  REQ_SITE_026["Generate & maintain a project presentation page<br><small>REQ-SITE-026</small>"]
  f_scripts_reqmap_py_2627_3935["scripts/reqmap.py:2627-3935"]
  REQ_SITE_026 -->|implements| f_scripts_reqmap_py_2627_3935
  f_scripts_test_reqmap_py_3164["scripts/test_reqmap.py:3164"]
  REQ_SITE_026 -->|tested-by| f_scripts_test_reqmap_py_3164
  REQ_TESTLINK_018["Test-link integrity check<br><small>REQ-TESTLINK-018</small>"]
  ...
  REQ_TESTLINK_018 -->|tested-by| f_scripts_test_reqmap_py_2337
  REQ_TRACE_020["Upstream traceability<br><small>REQ-TRACE-020</small>"]
  f_scripts_reqmap_py_812_2241["scripts/reqmap.py:812-2241"]
  REQ_TRACE_020 -->|implements| f_scripts_reqmap_py_812_2241
  f_scripts_test_reqmap_py_2471["scripts/test_reqmap.py:2471"]
  REQ_TRACE_020 -->|tested-by| f_scripts_test_reqmap_py_2471
  REQ_VIEWER_007["Self-contained HTML map viewer<br><small>REQ-VIEWER-007</small>"]
  f_scripts_reqmap_py_3693_3715["scripts/reqmap.py:3693-3715"]
  REQ_VIEWER_007 -->|implements| f_scripts_reqmap_py_3693_3715
