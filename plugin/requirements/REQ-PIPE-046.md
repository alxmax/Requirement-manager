...
depends_on: [REQ-CMDREGISTRY-033]     # ids of bus/other capabilities this builds on
...
## Links
- Sibling: [[REQ-CMDREGISTRY-033]] (the command registry the entry point dispatches from).
