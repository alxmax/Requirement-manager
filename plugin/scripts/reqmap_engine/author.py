"""The requirement template, the id/number checks around it, and frontmatter status."""
import os, re

from .parse import split_requirement_blocks


# The shape a requirement follows, kept after `new` was removed in v8.0.0 (ADR-0045
