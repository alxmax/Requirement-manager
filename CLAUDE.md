...
python scripts/reqmap.py ask --design --code ..   # advisory OOP review of the code: 4 pillars + files <= 500 lines, lines <= 80 columns (--json; ADR-0051)
